...
class plSwimRegionInterface(plObjInterface):    
    ...
    def export_obj(self,obj):
        ...
        self.fUpBuoyancy = FindInDict(objscript,"region.swim.buoyancy.up",self.fDownBuoyancy)
        self.fDownBuoyancy = FindInDict(objscript,"region.swim.buoyancy.down",self.fUpBuoyancy)
